...
#
# arty_hw.tcl: Tcl script for re-creating project 'arty_hw'
#
...
#
# 1. This project restoration tcl script (arty_hw.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/arty_hw"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/arty_hw/arty_hw.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
