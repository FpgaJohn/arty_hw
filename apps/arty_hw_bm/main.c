/*
 * arty_hw_bm -- bare-metal test for the arty_hw bitstream.
 *
 * Vitis "Standalone Empty Application" targeting arty_hw.xsa (ps7_cortexa9_0).
 * Three tests: GPIO accumulator, AXI Stream FIFO loopback, AXI DMA echo.
 *
...
/* ---- Test 1: GPIO accumulator (dual-channel) ---- */
...
static int test_dma(void)
{
    ...
    xil_printf("  after reset:  MM2S SR=0x%08x  S2MM SR=0x%08x\r\n",
...
int main(void)
{
    ...
    xil_printf("\r\n=========================================\r\n");
    xil_printf("arty_hw_bm bare-metal test\r\n");
    xil_printf("=========================================\r\n");
